/*! phaserJS-HTML5-snake-game 2015-10-27 */
...
null===this.snapshot?void console.warn("Video.grab cannot run because Phaser.BitmapData is unavailable"):(a&&this.snapshot.cls(),this.snapshot.copy(this.video,0,0,this.width,this.height,0,0,this.width,this.height,0,0,0,1,1,b,c),this.snapshot)},removeVideoElement:function(){if(this.video){for(this.video.parentNode&&this.video.parentNode.removeChild(this.video);this.video.hasChildNodes();)this.video.removeChild(this.video.firstChild);this.video.removeAttribute("autoplay"),this.video.removeAttribute("src"),this.video=null}},destroy:function(){this.stop(),this.removeVideoElement(),this.touchLocked&&this.game.input.touch.removeTouchLockCallback(this.unlock,this),this._retryID&&window.clearTimeout(this._retryID)}},Object.defineProperty(c.Video.prototype,"currentTime",{get:function(){return this.video?this.video.currentTime:0},set:function(a){this.video.currentTime=a}}),Object.defineProperty(c.Video.prototype,"duration",{get:function(){return this.video?this.video.duration:0}}),Object.defineProperty(c.Video.prototype,"progress",{get:function(){return this.video?this.video.currentTime/this.video.duration:0}}),Object.defineProperty(c.Video.prototype,"mute",{get:function(){return this._muted},set:function(a){if(a=a||null){if(this._muted)return;this._codeMuted=!0,this.setMute()}else{if(!this._muted)return;this._codeMuted=!1,this.unsetMute()}}}),Object.defineProperty(c.Video.prototype,"paused",{get:function(){return this._paused},set:function(a){if(a=a||null,!this.touchLocked)if(a){if(this._paused)return;this._codePaused=!0,this.setPause()}else{if(!this._paused)return;this._codePaused=!1,this.setResume()}}}),Object.defineProperty(c.Video.prototype,"volume",{get:function(){return this.video?this.video.volume:1},set:function(a){0>a?a=0:a>1&&(a=1),this.video&&(this.video.volume=a)}}),Object.defineProperty(c.Video.prototype,"playbackRate",{get:function(){return this.video?this.video.playbackRate:1},set:function(a){this.video&&(this.video.playbackRate=a)}}),Object.defineProperty(c.Video.prototype,"loop",{get:function(){return this.video?this.video.loop:!1},set:function(a){a&&this.video?this.video.loop="loop":this.video&&(this.video.loop="")}}),Object.defineProperty(c.Video.prototype,"playing",{get:function(){return!(this.video.paused&&this.video.ended)}}),c.Video.prototype.constructor=c.Video,void 0===PIXI.blendModes&&(PIXI.blendModes=c.blendModes),void 0===PIXI.scaleModes&&(PIXI.scaleModes=c.scaleModes),void 0===PIXI.Texture.emptyTexture&&(PIXI.Texture.emptyTexture=new PIXI.Texture(new PIXI.BaseTexture)),void 0===PIXI.DisplayObject._tempMatrix&&(PIXI.DisplayObject._tempMatrix=new PIXI.Matrix),void 0===PIXI.RenderTexture.tempMatrix&&(PIXI.RenderTexture.tempMatrix=new PIXI.Matrix),PIXI.Graphics&&void 0===PIXI.Graphics.POLY&&(PIXI.Graphics.POLY=c.POLYGON,PIXI.Graphics.RECT=c.RECTANGLE,PIXI.Graphics.CIRC=c.CIRCLE,PIXI.Graphics.ELIP=c.ELLIPSE,PIXI.Graphics.RREC=c.ROUNDEDRECTANGLE),PIXI.TextureSilentFail=!0,"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=c),exports.Phaser=c):"undefined"!=typeof define&&define.amd?define("Phaser",function(){return b.Phaser=c}()):b.Phaser=c,c}.call(this);var gameOver={preload:function(){game.load.image("gameOver","assets/images/game-over.png")},create:function(){this.add.button(0,0,"gameOver",this.startGame,this),game.add.text(240,145,"LAST SCORE:",{font:"bold 30px sans-serif",fill:"#46c0f9",align:"center"}),game.add.text(450,145,score.toString(),{font:"bold 30px sans-serif",fill:"#fff",align:"left"})},startGame:function(){this.state.start("mainGame")}},snake,fruit,squareSize,updateDelay,direction,newDirection,addNew,controller,score,speed,scoreTextValue,speedTextValue,scoreTextStyle,speedTextStyle,mainGame={preload:function(){game.load.image("snake-tile","assets/images/snake-tile.png"),game.load.image("fruit","assets/images/fruit.png")},create:function(){snake=[],fruit={},squareSize=15,score=0,speed=0,updateDelay=0,direction="right",newDirection=null,addNew=!1,controller=game.input.keyboard.createCursorKeys(),game.stage.backgroundColor="#061f27";for(var a=0;10>a;a++)snake[a]=game.add.sprite(150+a*squareSize,150,"snake-tile");this.generateFruit(),scoreTextStyle={font:"bold 14px sans-serif",fill:"#46c0f9",align:"center"},speedTextStyle={font:"bold 14px sans-serif",fill:"#fff",align:"center"},game.add.text(30,20,"SCORE:",scoreTextStyle),scoreTextValue=game.add.text(90,20,score.toString(),scoreTextStyle),game.add.text(30,40,"SPEED:",speedTextStyle),speedTextValue=game.add.text(90,40,speed.toString(),speedTextStyle)},update:function(){if(controller.right.isDown&&"left"!=direction?newDirection="right":controller.left.isDown&&"right"!=direction?newDirection="left":controller.up.isDown&&"up"!=direction?direction="up":controller.down.isDown&&"up"!=direction&&(direction="down"),speed=Math.min(10,Math.floor(score/5)),speedTextValue.text=speed.toString(),updateDelay++,updateDelay%(10-speed)==0){var a=snake[snake.length-1],b=snake.shift(),c=b.x,d=b.y;newDirection&&(direction=newDirection,newDirection=null),"right"==direction?(b.x=a.x+15,b.y=a.y):"left"==direction?(b.x=a.x-15,b.y=a.y):"up"==direction?(b.x=a.x,b.y=a.y-15):"down"==direction&&(b.x=a.x,b.y=a.y+15),snake.push(b),a=b,addNew&&(snake.unshift(game.add.sprite(c,d,"snake-tile")),addNew=!1),this.fruitCollision(),this.selfCollision(a),this.wallCollision(a)}},generateFruit:function(){var a=Math.floor(40*Math.random())*squareSize,b=Math.floor(30*Math.random())*squareSize;fruit=game.add.sprite(a,b,"fruit")},fruitCollision:function(){for(var a=0;a<snake.length;a++)snake[a].x==fruit.x&&snake[a].y==fruit.y&&(addNew=!0,fruit.destroy(),this.generateFruit(),score++,scoreTextValue.text=score.toString())},selfCollision:function(a){for(var b=0;b<snake.length-1;b++)a.x==snake[b].x&&a.y==snake[b].y&&game.state.start("gameOver")},wallCollision:function(a){(a.x>=800||a.x<0||a.y>=600||a.y<0)&&game.state.start("gameOver")}},menu={preload:function(){game.load.image("menu","assets/images/menu.png")},create:function(){game.add.button(0,0,"menu",this.startGame,this)},startGame:function(){game.state.start("mainGame")}},splash={duration:100,preload:function(){game.load.image("splash","assets/images/splash.png")},create:function(){game.add.sprite(0,0,"splash")},update:function(){this.duration--,this.duration<=0&&this.loadMenu()},loadMenu:function(){game.state.start("menu")}},game;game=new Phaser.Game(800,600,Phaser.AUTO,""),game.state.add("splash",splash),game.state.add("menu",menu),game.state.add("mainGame",mainGame),game.state.add("gameOver",gameOver),game.state.start("splash");